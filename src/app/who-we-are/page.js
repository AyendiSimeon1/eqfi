...
const OpportunitySection = () => {
  return (
    <>
      {/* White Text Section */}
      <section className="py-24 px-8 md:px-24 max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
        <h2 className="text-[#1e4ba1] text-6xl font-serif leading-tight">
      ...
      <section className="bg-[#001a41] py-24 px-8 md:px-24 overflow-hidden">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-16">
          ...
          <div className="relative grid grid-cols-2 gap-4">
            <motion.div whileHover={{ scale: 1.05 }} className="mt-12">
              <img src="/office-1.jpg" alt="Office tech" className="w-full h-64 object-cover" />
            </motion.div>
            <motion.div whileHover={{ scale: 1.05 }}>
              <img src="/team-1.jpg" alt="Team meeting" className="w-full h-64 object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
  ...
  return (
    <section className="py-24 px-8 md:px-24 bg-white">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start mb-16 gap-8">
        <h2 className="text-[#1e4ba1] text-6xl font-serif leading-tight max-w-md">
          United by <br /> Our Culture
        </h2>
        <div className="max-w-md text-black">
          <p className="text-lg leading-relaxed mb-4">We are a multi-strategy alternative investment manager, pursuing superior long-term returns for our investors.</p>
          <p className="text-lg leading-relaxed">We bring together extraordinary people, equip them with unmatched resources and technology and empower them to seek out new possibilities in the markets.</p>
        </div>
      </div>
    ...
    <section className="py-24 px-8 md:px-24 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white p-8 md:p-12 rounded-lg shadow-lg">
          <h3 className="text-3xl font-semibold text-[#1e4ba1] mb-4">Investment Manager 1/ CIO</h3>
          <h4 className="text-2xl font-medium text-[#1e4ba1] mb-6">Oladipo Ehindero</h4>
